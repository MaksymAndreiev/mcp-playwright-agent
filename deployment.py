...
flags.DEFINE_string(
    "message",
    "",  # TODO: provide a default message if needed
...
def create() -> None:
    ...
    remote_app = agent_engines.create(
        ...
        extra_packages=["./mcp_playwright_agent"],
    )
...
def list_sessions(resource_id: str, user_id: str) -> None:
    ...
    # support either {'sessions': [...] } or a plain list
    sessions = sessions_resp.get("sessions") if isinstance(sessions_resp,
                                                                dict) and "sessions" in sessions_resp else sessions_resp
